// Code generated by the Encore v1.41.7 client generator. DO NOT EDIT.
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "elixir-money-73o2-Generated-TS-Client (Encore/v1.41.7)";
        }
