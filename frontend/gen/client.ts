// Code generated by the Encore v1.41.11 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
  return `https://${name}-elixir-money-73o2.encr.app`;
}
...
export namespace users {
  ...
  export class ServiceClient {
    ...
    public async LookupByPhoneNo(
      params: LookupByPhoneNoParams,
    ): Promise<LookupByPhoneNoResponse> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callAPI(
        'POST',
        `/users.LookupByPhoneNo`,
        JSON.stringify(params),
      );
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof window === 'undefined') {
      this.headers['User-Agent'] =
        'elixir-money-73o2-Generated-TS-Client (Encore/v1.41.11)';
    }
